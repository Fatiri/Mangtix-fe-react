...
export const fetchlocationsuccess={type:"FETCH_LOCATION_SUCCESS"}
export const handleeventname={type: "HANDLE_EVENT_NAME"}
export const handleeventimage={type: "HANDLE_EVENT_IMAGE"}
export const handleeventpdf={type: "HANDLE_EVENT_PDF"}
...
export const handleupdate={type:"HANDLE_UPDATE"}


export const eventLocation = {type: "HANDLE_EVENT_LOCATION"}
export const locationCity = {type: 'SUCCESS_INPUT_CITY'}
export const locationAddress = {type: 'SUCCESS_INPUT_ADDRESS'}
export const locationLatitude = {type: 'SUCCESS_INPUT_LATITUDE'}
export const locationLongitude = {type: 'SUCCESS_INPUT_LONGITUDE'}
