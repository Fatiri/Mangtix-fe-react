...
export const registrationBirthDate = {type: 'SUCCESS_INPUT_BIRTH_DATE'}
export const registrationNameCompany = {type: 'SUCCESS_INPUT_NAME_COMPANY'}
export const userIdCompany = {type: 'SUCCESS_INPUT_USER_ID'}